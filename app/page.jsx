...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const pesanError =
        err.response?.data?.error || "Gagal masuk! Cek koneksi server.";
      alert(pesanError);
    }
  };
  ...
  return (
    <>
      <div className="outer-tabs">
        <Link href="/" className="outer-tab active">
          🔐 Login
        </Link>
        <Link href="/register" className="outer-tab">
          📝 Daftar
        </Link>
      </div>
      ...
      <div className="login-shell">
        <div className="login-left">
          ...
          <p className="login-desc">
            Masuk untuk mengelola laporan penukaran uang Anda dan memantau
            status verifikasi secara real-time di wilayah NTT.
          </p>
          ...
          >
            <div className="login-feat">
              ...
              <div className="feat-text">Koneksi aman terenkripsi SSL</div>
            </div>
            <div className="login-feat">
              <div className="feat-dot"></div>
              <div className="feat-text">
                Akses langsung ke pusat bantuan BI
              </div>
            </div>
          </div>
        </div>
